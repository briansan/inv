 ...
 */
public class ManufacturerArrayAdapter extends ArrayAdapter<Label.ItemManufacturer> {
    ...
    public ManufacturerArrayAdapter(Context ctxt, int res, ArrayList<Label.ItemManufacturer> manufacturers) {
        super(ctxt, res, manufacturers);
    }

    public View getView(int pos, View v, ViewGroup p) {
        Cell cell;
        Label.ItemManufacturer i = getItem(pos);
        ...
        HashMap<String,ArrayList<Item>> map = DataManager.sharedManager().getManufacturerItemMap();
